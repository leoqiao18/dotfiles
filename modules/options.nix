...
with lib.my; {
  options = with types; {
    ...
    dotfiles = {
      dir = mkOpt path (findFirst pathExists (toString ../.) [
        ...
        "${config.user.home}/git/LeoQiao18/dotfiles"
        "/etc/dotfiles"
      ]);
  ...
  config = {
    ...
    home-manager = {
      ...
      # home.X (option)  ->  home-manager.users.lqiao.home.inser-option-here
      # home.configFile  ->  home-manager.users.lqiao.home.xdg.configFile
      # home.dataFile    ->  home-manager.users.lqiao.home.xdg.dataFile
